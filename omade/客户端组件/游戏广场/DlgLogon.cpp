...
BOOL CDlgRegister::OnInitDialog()
{
	...
	m_LineRegWeb.SetHyperLinkUrl(TEXT("http://205168.cqxunmei.com"));
	m_LineMainPage.SetHyperLinkUrl(TEXT("http://205168.cqxunmei.com"));
	m_LinePassWord.SetHyperLinkUrl(TEXT("http://205168.cqxunmei.com"));
...
BOOL CDlgLogon::OnInitDialog()
{
	...
	m_BrowerAD.Navigate(TEXT("http://205168.cqxunmei.com/AD/LogonAD.asp"),NULL,NULL,NULL,NULL);
	...
	//设置控件
	m_LineMainPage.SetHyperLinkUrl(TEXT("http://205168.cqxunmei.com"));
	m_LinePassWord.SetHyperLinkUrl(TEXT("http://205168.cqxunmei.com/Passwordprotection.asp"));
	m_LineGetPassWord.SetHyperLinkUrl(TEXT("http://205168.cqxunmei.com/FindPassWord.asp"));
...
void CDlgLogon::LoadLogonServer()
{
	...
	{
		pComBoxServer->AddString(TEXT("205168.cqxunmei.com"));
...
{
//#ifndef _DEBUG
//	ShellExecute(NULL,TEXT("open"),TEXT("http://205168.cqxunmei.com/service/viewrule.jsp"),NULL,NULL,SW_SHOWDEFAULT);
//	return;
//#endif
	...
	//服务器
	GetDlgItemText(IDC_SERVER,m_strLogonServer);
	if (m_strLogonServer.IsEmpty()) m_strLogonServer=TEXT("205168.cqxunmei.com");
