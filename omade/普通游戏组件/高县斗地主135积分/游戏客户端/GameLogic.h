...
public:
	...
	// 根据丁丁个?判断是否必打 ( 大小王，2，炸弹个数)
	bool AnalyseIsBiDa(BYTE const cbHandCardData[],BYTE cbHandCardCount);
	bool AnalyseHave2KingOr4Two(BYTE const cbHandCardData[],BYTE cbHandCardCount);
};
