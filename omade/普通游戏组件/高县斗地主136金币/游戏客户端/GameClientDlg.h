...
protected:
	...
	bool							m_bLookCard;						//看牌变量
	bool							m_bIsBackCatch;                   //闷抓
	BYTE							m_cbCallBankTimes;                  // 叫庄次数
	bool							m_bLookAndGiveup;                   // 看牌不抓
	//出牌变量
protected:
...
protected:
	...
	// 送分消息
	bool OnSubGrantScore( const void *pBuffer, WORD wDataSize );
