...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("高县斗地主游戏服务组件金币"),CountArray(m_GameServiceAttrib.szDescription));
	...
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("LandSCGoldServer.dll"),CountArray(m_GameServiceAttrib.szServerModuleName));
#endif
