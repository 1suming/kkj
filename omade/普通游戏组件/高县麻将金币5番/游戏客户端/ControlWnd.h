...
public:
	...
	//设置扑克
	void SetControlInfo(BYTE cbCenterCard, BYTE cbActionMask, tagGangCardResult & GangCardResult,tagTICardResult & TICardResult, BYTE cbMagicCard);
	//内部函数
protected:
	//调整控件
	void RectifyControl();
