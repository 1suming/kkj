...
void CServiceParameter::UpdateOptionParameter()
{
	...
	WORD wGameGenre[4]={GAME_GENRE_LONGMATCH,GAME_GENRE_MATCH,GAME_GENRE_GOLD,GAME_GENRE_SCORE};
	LPCTSTR pszGameGenre[4]={TEXT("赛分类型"),TEXT("比赛类型"),TEXT("金币类型"),TEXT("点值类型")};
